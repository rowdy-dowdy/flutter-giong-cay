...
import 'package:sample/components/ui/Landing.dart';
import 'package:sample/controllers/auth_controller.dart';
import 'package:sample/controllers/landing_controller.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ),).tr().animate().fade(duration: 300.ms).slideY(begin: 2),
                  const SizedBox(height: 5,),
                  const Text("Hello again, did you miss", style: TextStyle(
                    // color: grey,
                  ),).tr().animate().fade(delay: 100.ms, duration: 300.ms).slideY(begin: 2),
                  ...
                  Expanded(
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Expanded(
                            child: Center(
                              ...
                              ).animate().fade(delay: 200.ms, duration: 300.ms).scale(),
                            ),
                          ),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        ].animate(interval: 100.ms, delay: 300.ms).fade(duration: 300.ms).slideY(begin: 2),
                      ),
                    ),
                  ),
                  SizedBox(
                    ...
                    ).tr().animate().fade(delay: 800.ms, duration: 300.ms).slideY(begin: 2),
                  ),
                  const SizedBox(height: 20,)
                ],
              ),
